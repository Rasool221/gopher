...
type CLIConfig struct {
	...
	Depth    int    `short:"d" default:"0" help:"Maximum depth to crawl links from beginning (0 for unlimited)."`
	...
	Output   int    `short:"o" default:"0" help:"Output file to write the URL map to (0=stdout, 1=sqlite)."`                                           // TODO: HTML page output of a graph-based URL map
